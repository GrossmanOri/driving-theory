// Inline SVG icons, Lucide-style outline. See DESIGN_PLAN spec.
// Signature: <IconX size={20} className="" /> → sized, currentColor stroke.
...
export function IconStar({ size = 20, className = '', fill = 'none' }) {
  return (
    <Svg size={size} className={className}>
      <polygon
        fill={fill}
...
export function IconRotate({ size = 20, className = '' }) {
  return (
    <Svg size={size} className={className}>
...
export function IconGraduation({ size = 20, className = '' }) {
  return (
    <Svg size={size} className={className}>
...
export function IconSigns({ size = 20, className = '' }) {
  return (
    <Svg size={size} className={className}>
      <path d="M12 13v8" />
      <path d="M12 3v3" />
